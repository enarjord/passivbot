...
or make a new configuration file, using `configs/examples/default_trailing_martingale_long_npos4.json` as a starting point, and start the bot with:
...
`configs/examples/default_trailing_martingale_long_npos4.json` mirrors that default profile exactly, so
