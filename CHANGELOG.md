...
- `live.pnls_max_lookback_days` now uses one consistent contract across live risk logic, HSL, plotting, and backtests: `0` means minimal lookback, positive numbers mean that many rolling days, and `"all"` means full available history.
