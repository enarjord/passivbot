...
- Redact complete quoted generic credentials, quote-containing unquoted credentials,
  ...
  equals-style credential flags, and URL userinfo across supported schemes with or without a
  password delimiter in retained diagnostics. Keep terminal startup and outer process failure
  console records within the normal bounded projection budget.
