...
- Added `passivbot tool pareto-analyze` and `passivbot tool pareto-compress` for inspecting Pareto-front metric/config distributions and selecting compact representative subsets with optional copied JSON output.
