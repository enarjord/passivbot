...
- Added `passivbot tool pareto-compress` for selecting a compact, non-destructive representative subset from a Pareto front, with optional copied JSON output and a selection manifest.
