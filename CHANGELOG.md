...
- Detailed per-symbol min-effective-cost entry blocks now log at INFO on first occurrence, blocked-set changes, or periodic heartbeat; unchanged repeated blocks are suppressed to DEBUG to keep normal logs actionable.
