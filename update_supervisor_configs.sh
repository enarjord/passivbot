...
rm -f ${SUPERVISOR_CONFIG_DIR}/passivbot_*.conf
...
python /opt/passivbot/passivbot.py binance_01 ${symbol} ${config_file}
EOT
    ...
    cat <<EOT > ${SUPERVISOR_CONFIG_DIR}/passivbot_${symbol}.conf
