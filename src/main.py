...
if __name__ == "__main__":
    ...
    parser.add_argument("--force-rust-compile", action="store_true", help="Force rebuild of Rust extension.")
    parser.add_argument(
        "--fail-on-stale-rust",
        action="store_true",
    ...
    try:
        check_and_maybe_compile(
            skip=known_args.skip_rust_compile or os.environ.get("SKIP_RUST_COMPILE", "").lower() in ("1", "true", "yes"),
