...
class Sync(CLICommand):
    ...
    def run(cli):
        ...
        logger.info("you are about to stop all instances that are currently running.")
        logger.info("Only the instances that are currently in the config file will be started again.")
