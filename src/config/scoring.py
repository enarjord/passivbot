...
DEFAULT_OBJECTIVE_GOALS = {
    ...
    "drawdown_worst_mean_1pct_ema_strategy_eq": "min",
    ...
    "peak_recovery_hours_strategy_eq_long": "min",
    "peak_recovery_hours_strategy_eq_short": "min",
    "peak_recovery_days_strategy_eq_long": "min",
    "peak_recovery_days_strategy_eq_short": "min",
    "mdg_pnl": "max",
    "mdg_pnl_w": "max",
