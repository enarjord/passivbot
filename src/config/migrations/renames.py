...
LEGACY_ENTRY_GRID_KEYS = {
    ...
    "entry_grid_spacing_weight": "entry_we_weight",
    "entry_grid_spacing_log_span_hours": "entry_volatility_ema_span_1h",
    "entry_log_range_ema_span_hours": "entry_volatility_ema_span_1h",
    "entry_grid_spacing_log_weight": "entry_weight_volatility_1h",
    "entry_trailing_retracement_log_weight": "entry_weight_volatility_1h",
    "entry_trailing_threshold_log_weight": "entry_weight_volatility_1h",
}
...
LEGACY_BOUNDS_KEYS = {
    ...
    "long_filter_volume_rolling_window": "long_forager_volume_ema_span_1m",
    "long_filter_log_range_ema_span": "long_forager_volatility_ema_span_1m",
    ...
    "short_filter_noisiness_rolling_window": "short_forager_volatility_ema_span_1m",
    "short_filter_noisiness_ema_span": "short_forager_volatility_ema_span_1m",
    "short_filter_volume_rolling_window": "short_forager_volume_ema_span_1m",
    "short_filter_log_range_ema_span": "short_forager_volatility_ema_span_1m",
    ...
    "long_entry_grid_spacing_weight": "long_entry_we_weight",
    "short_entry_grid_spacing_weight": "short_entry_we_weight",
    "long_entry_grid_spacing_log_span_hours": "long_entry_volatility_ema_span_1h",
    "short_entry_grid_spacing_log_span_hours": "short_entry_volatility_ema_span_1h",
    "long_entry_log_range_ema_span_hours": "long_entry_volatility_ema_span_1h",
    "short_entry_log_range_ema_span_hours": "short_entry_volatility_ema_span_1h",
    "long_entry_grid_spacing_log_weight": "long_entry_weight_volatility_1h",
    "short_entry_grid_spacing_log_weight": "short_entry_weight_volatility_1h",
    "long_entry_trailing_retracement_log_weight": "long_entry_weight_volatility_1h",
    "short_entry_trailing_retracement_log_weight": "short_entry_weight_volatility_1h",
    "long_entry_trailing_threshold_log_weight": "long_entry_weight_volatility_1h",
    "short_entry_trailing_threshold_log_weight": "short_entry_weight_volatility_1h",
}
