...
from passivbot.utils.procedures import get_starting_configs
...
def pso_multiprocess(
    ...
    while True:
        if itr_counter >= iters:
            ...
            if workers[worker_cycler] is None:
                if pos_cycler not in working:
                    ...
                    working = {e[0] for e in workers if e is not None}
        ...
        if workers[worker_cycler] is not None and workers[worker_cycler][1].ready():
            ...
            velocities[pos_cycler], positions[pos_cycler] = get_new_velocity_and_position(
                velocities[pos_cycler], positions[pos_cycler], lbests[pos_cycler], gbest
            )
...
class BacktestWrap:
    ...
    def rf(self, xs):
        ...
        for key in [
            ...
            "mean_hrs_between_fills_shrt",
            "max_hrs_no_fills_long",
            "max_hrs_no_fills_shrt",
