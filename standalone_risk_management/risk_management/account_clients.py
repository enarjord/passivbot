...
from .ccxt_helpers import load_ccxt_instance, normalize_exchange_name
...
def _apply_credentials(client: Any, credentials: Mapping[str, Any]) -> None:
    ...
    for key, value in credentials.items():
        ...
        if key in sensitive_fields:
            ...
            # Historical compatibility: mirror the "ccxt_config" handling from the
...
def _instantiate_ccxt_client(exchange_id: str, credentials: Mapping[str, Any]) -> Any:
    """Instantiate a ccxt async client configured for the realtime fetcher."""
