...
@pytest.mark.asyncio
async def test_prepare_hlcvs_mss_stock_perp_uses_direct_prepare_fallback(monkeypatch, tmp_path):
    import rust_utils
    ...
    async def fail_try_prepare(*args, **kwargs):
        raise AssertionError("stock-perp source-dir fallback must not call strict v2 directly")
