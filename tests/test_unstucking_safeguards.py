...
def test_hard_stop_apply_sample_delegates_to_rust(monkeypatch):
    ...
    metrics = bot._equity_hard_stop_apply_sample(1_700_000_000_000, 900.0, 25.0, 50.0)
...
def test_hard_stop_apply_sample_rolling_peak_prunes_by_lookback():
    ...
    m0 = bot._equity_hard_stop_apply_sample(1_000, 100.0, 0.0, 0.0)
    m1 = bot._equity_hard_stop_apply_sample(61_000, 95.0, 0.0, 0.0)
...
def test_hard_stop_apply_sample_same_minute_returns_cached_metrics_without_recomputing_peak():
    ...
    first = bot._equity_hard_stop_apply_sample(60_000, 100.0, 0.0, 0.0)
    second = bot._equity_hard_stop_apply_sample(60_500, 90.0, 0.0, 0.0)
