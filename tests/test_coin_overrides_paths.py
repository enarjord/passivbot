...
def test_file_override_entry_cooldown_is_flattened_for_live_bp(tmp_path):
    """File-loaded cooldown must install flat key after parse (live skips recompile)."""
    ...
    assert hype["risk_entry_cooldown_minutes"] == pytest.approx(50.0)
