...
impl Default for Analysis {
    fn default() -> Self {
        Analysis {
            ...
            strategy_eq_recovery_days_p99: 0.0,
            strategy_eq_recovery_days_mean_worst_5pct: 0.0,
            strategy_eq_recovery_days_mean_worst_1pct: 0.0,
            strategy_eq_recovery_days_max: 0.0,
