...
const TRAILING_GRID_PARAM_SEEDS: &[ParamSeed] = &[
    ...
    ParamSeed {
        name: "close_weight_volatility_1h",
        long_default: 0.0,
        short_default: 0.0,
    ...
    ParamSeed {
        name: "close_weight_volatility_1m",
        long_default: 0.0,
        short_default: 0.0,
        long_bounds: &[0.0, 40.0, 0.1],
        short_bounds: &[0.0, 40.0, 0.1],
    ...
    ParamSeed {
        name: "entry_volatility_ema_span_minutes",
        long_default: 60.0,
        short_default: 60.0,
    ...
    ParamSeed {
        name: "entry_weight_volatility_1h",
        long_default: 2.4,
        short_default: 1.0,
        long_bounds: &[0.0, 40.0, 0.1],
        short_bounds: &[0.0, 40.0, 0.1],
    ...
    ParamSeed {
        name: "entry_weight_volatility_1m",
        long_default: 0.0,
        short_default: 0.0,
        long_bounds: &[0.0, 40.0, 0.1],
        short_bounds: &[0.0, 40.0, 0.1],
