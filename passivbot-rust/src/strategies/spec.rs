...
const TRAILING_MARTINGALE_PARAM_SEEDS: &[NestedParamSeed] = &[
    ...
    NestedParamSeed {
        ...
        long_default: 0.94,
        short_default: 0.2,
        long_bounds: &[0.2, 1.2, 0.01],
        short_bounds: &[0.2, 2.0, 0.01],
    },
    NestedParamSeed {
    ...
    NestedParamSeed {
        ...
        short_bounds: &[0.0001, 0.015, 0.0001],
    },
    NestedParamSeed {
    ...
    NestedParamSeed {
        ...
        long_default: -0.0027,
        short_default: -0.02,
        long_bounds: &[-0.005, 0.01, 0.0001],
        short_bounds: &[-0.05, 0.02, 0.0001],
    },
    NestedParamSeed {
