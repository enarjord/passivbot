...
| 2026-07-16 | #3 Live restart/smoke automation | Active `codex/restart-target-contract-fingerprint`, after PR #1290 / `b490bd75be` | PR #1290 deployed pane-parent relaunch classification for all five exact targets; active work binds the sampled target set to the parsed supervisor command contract without exposing command content | Review and validate contract-drift failure; safe pull/stop/start execution remains open |
