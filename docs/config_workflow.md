...
- New V8 configs must keep the top-level `config_version: "v8.2.0"` field. V8 is a breaking schema; v7 and pre-v8 configs are not automatically converted to V8.
