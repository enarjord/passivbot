...
```shell
passivbot download configs/examples/default_trailing_martingale_long_npos4.json
...
`configs/examples/default_trailing_martingale_long_npos4.json`. Enable it only when you deliberately
