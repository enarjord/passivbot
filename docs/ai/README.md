...
| Fill/PnL ingestion, fees, coverage, binary outcomes | `error_contract.md`, `features/fill_events_manager.md`, `features/outcome_markets.md`, relevant exchange contract |
