...
- `order.churn_evidence` reports one bounded per-plan aggregation of RAM-history association
  ...
  History starts empty and is cleared after planning failure, gate disablement, symbol-local
  normalization failure, or a symbol leaving the current ideal/active/order/position universe.
