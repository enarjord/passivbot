...
- manual-entry-during-cooldown flows for the currently covered live policies:
  `panic`, `normal`, `manual`, `tp_only`, and `graceful_stop`

Coverage split:

- unit tests are the exhaustive HSL cooldown-contract matrix
- fake-live tests are the representative end-to-end subset
