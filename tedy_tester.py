...
print("Start")
#Edit:
config = {'starting_balance': 100, # your starting balance in $
          'wallet_exposure_limit': 0.15, # your wallet exposure
          'initial_qty_pct': 0.016877534968530956} # the initial_qty_pct picked from the config you will run
